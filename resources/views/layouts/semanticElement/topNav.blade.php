        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">
                ...
                <b class="logo-icon">
                    ...
                    <!-- Dark Logo icon -->
                    <img src="https://v2.sorsu.edu.ph/wp-content/uploads/2023/04/sorsu.png" style="height: 45px;" alt="homepage" class="dark-logo" />
                    <!-- Light Logo icon -->
                    <img src="https://v2.sorsu.edu.ph/wp-content/uploads/2023/04/sorsu.png" style="height: 45px;" alt="homepage" class="light-logo" />
                </b>
                <!--End Logo icon -->
                <!-- Logo text -->
                <span class="logo-text">
                    ...
                    {{-- <h6 class="dark-logo" style="color: #fff; font-style: normal; font-size: 150px;">SSU Clinic</h6> --}}
                    <!-- Light Logo text -->
                    {{-- <img src="../assets/images/logo-light-text.png" class="light-logo" alt="homepage" /> --}}
                    <h6 class="light-logo text-center mt-2" style="color: #fff; font-style: normal; font-size: 12px;">SorSU Bulan Campus Clinic</h6>
                </span>
            </a>
            <!-- ============================================================== -->
            <!-- End Logo -->
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown"
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg" alt="user" width="30" class="profile-pic rounded-circle" />
                    </a>
                    <div class="dropdown-menu mailbox dropdown-menu-right scale-up">
                        <ul class="dropdown-user list-style-none">
                            <li>
                                <div class="dw-user-box p-3 d-flex">
                                    <div class="u-img"><img src="https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg" alt="user" class="rounded" width="80"></div>
                            ...
                            @csrf
                                <li class="user-list"><a class="px-3 py-2" href="route('logout')"
                                    onclick="event.preventDefault();
                                                this.closest('form').submit();"><i class="fa fa-power-off"></i> Logout</a></li>
                            </form>
